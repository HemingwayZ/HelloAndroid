package com.hemingway.editpic.clip;
...
public class IMGClipWindow implements IMGClip {
    ...
    public void onDrawShade(Canvas canvas) {
        // 计算遮罩图形
        mShadePath.reset();
        mShadePath.addRect(mFrame.left-2 , mFrame.top -2, mFrame.right +2, mFrame.bottom +2, Path.Direction.CW);
        mShadePath.addRect(mWin, Path.Direction.CCW);
